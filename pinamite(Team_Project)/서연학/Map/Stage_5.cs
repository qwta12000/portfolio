...
public class Stage_5 : MonoBehaviour
{
            ...
            for (int z = 0; z < znode; z++)
            {
                ...
                else
                {
                    ...
                    if (randNum <= 2)
                    {
                        ...
                        {
                            Instantiate(box, new Vector3(xpos, transform.position.y + 0f, zpos), Quaternion.identity);
                    ...
                    else if (randNum == 6)
                    {
                        ...
                        {
                            Instantiate(kinetic_3, new Vector3(xpos, transform.position.y + 0f, zpos), Quaternion.identity);
                        }
                    }
                }
            }
    ...
    void Start()
    {
        ...
        MgerClass.InstFunc.sevestage("Stage_5");
    ...
    IEnumerator blink_eft()
    {
        while (count <= 8)
        {
            ...
            text_stage_5.text = "Stage 5";
            yield return new WaitForSeconds(0.1f);
            count++;

            if (count == 8)
            {
                text_stage_5.enabled = false;
